        ...
        <div className="space-y-3">
          ...
          <div className="grid grid-cols-2 gap-2">
            {technologies.map((tech, index) => (
              <div
                key={index}
                className="text-sm text-white/80 bg-white/5 px-2 py-1 rounded">
                {tech}
              </div>
            ))}
          </div>
          ...
          <div className="h-full grid grid-cols-1 lg:grid-cols-3 gap-4">
                    ...
                    <Tooltip>
                      <TooltipTrigger asChild>
                        <div className="cursor-pointer h-full">
                          <GlassCard
                            delay={index * 0.1}
                            className="flex flex-col items-center justify-center text-center h-full hover:bg-white/15 transition-all duration-300">
                            <motion.div
                              initial={{ scale: 0 }}
                              animate={{ scale: 1 }}
                              transition={{
                            ...
                            <div className="subtitle text-white text-xs sm:text-sm font-medium">
                              {stat.label}
                            </div>
                          </GlassCard>
                        </div>
            ...
            <div className="h-fit lg:h-full">
              <GlassCard
                ...
                <div className="space-y-2">
                  <div>
                    <h4 className="subtitle text-sm sm:text-base font-semibold text-white">
                  ...
                  <div className="flex items-center justify-between pt-2 border-t border-white/10">
                    <span className="subtitle text-white text-xs sm:text-sm">
                      CGPA
                    </span>
                    <span className="text-base sm:text-lg font-bold gradient-text">
                      {data.education.cgpa}/10
                    </span>
                  </div>
                </div>
              </GlassCard>
